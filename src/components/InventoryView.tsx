    ...
    <div className="space-y-4 min-h-[500px]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-800 p-5 rounded-xl border border-slate-700">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">Ficha técnica optimizada por producto: Costo Landed, Precio Sugerido (+15%) y Valoración GTQ/USD</p>
        </div>
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold px-4 py-2.5 rounded-xl text-sm transition shadow-lg shadow-blue-600/20 shrink-0"
        >
      ...
      {/* Summary KPI Cards (Horizontal Scroll Ribbon on Mobile) */}
      <div className="flex overflow-x-auto gap-4 scrollbar-none pb-2 snap-x snap-mandatory sm:grid sm:grid-cols-3 sm:overflow-visible">
        <div className="shrink-0 w-[270px] sm:w-auto snap-start bg-slate-800 p-4 rounded-xl border border-slate-700">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400 uppercase">SKUs Únicos</span>
            <div className="p-2 bg-blue-500/10 text-blue-400 rounded-lg"><Boxes className="w-5 h-5" /></div>
          </div>
          <h3 className="text-2xl font-bold text-white mt-2">{totalUniqueSkus} Catálogos</h3>
          <span className="text-xs text-slate-400">Sin duplicados en SQLite</span>
        </div>

        <div className="shrink-0 w-[270px] sm:w-auto snap-start bg-slate-800 p-4 rounded-xl border border-slate-700">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400 uppercase">Stock Total Almacén</span>
            <div className="p-2 bg-indigo-500/10 text-indigo-400 rounded-lg"><PackageCheck className="w-5 h-5" /></div>
          </div>
          <h3 className="text-2xl font-bold text-white mt-2">{totalStockUnits} Unidades</h3>
          <span className="text-xs text-indigo-400 font-medium">Físico acumulado</span>
        </div>

        <div className="shrink-0 w-[270px] sm:w-auto snap-start bg-slate-800 p-4 rounded-xl border border-slate-700">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400 uppercase">Valoración Total</span>
            <div className="p-2 bg-emerald-500/10 text-emerald-400 rounded-lg"><DollarSign className="w-5 h-5" /></div>
          </div>
          <h3 className="text-xl font-bold text-white mt-1">${totalInventoryValue.toLocaleString('en-US', { minimumFractionDigits: 2 })} USD</h3>
